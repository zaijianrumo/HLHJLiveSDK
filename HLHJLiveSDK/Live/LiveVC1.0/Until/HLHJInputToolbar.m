...
@interface HLHJInputToolbar () <UITextViewDelegate>
...
@implementation HLHJInputToolbar
...
- (void)setIsRectEdgeNone:(BOOL)isRectEdgeNone {
    
    _isRectEdgeNone = isRectEdgeNone;
}
// 添加通知
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if (self.textInput.scrollEnabled) {
        ...
        if (_isRectEdgeNone) {
           self.y = SCREEN_HEIGHT - _keyboardHeight - _textInputHeight - 5 - 10;
        }else{
